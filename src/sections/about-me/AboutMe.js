      ...
      <div className="details">
        ...
        <div className="info">
          <div className="text">
            ...
            Sou graduando em Sistemas de Informação na USP, Universidade de São Paulo.
            Além disso, trabalho na Cleartech, onde enfrento diversos desafios e colaboro
            para a construção de aplicações de alta complexidade.
